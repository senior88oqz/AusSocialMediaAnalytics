...
screen -S harvest1 -d -m /share/app/harvest/venv3/bin/python /share/app/harvest/harvest.py -k /share/app/harvest/keys1 -l /share/app/web/webroot/data/rvester-log1.txt
