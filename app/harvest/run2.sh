...
cd /share/app/harvest
screen -S harvest2 -d -m /share/app/harvest/venv3/bin/python /share/app/harvest/harvest.py -k /share/app/harvest/keys2 -l /share/app/web/webroot/data/rvester-log2.txt
